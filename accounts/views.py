...
from django.forms import inlineformset_factory#ways of creating multiple forms within one form
from .models import *
...
def home(request):
    ...
    return render(request, 'accounts/dashboard.html', context)#render takes in a few parameters
