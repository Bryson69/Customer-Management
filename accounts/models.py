...
class Order(models.Model):
    ...
    customer = models.ForeignKey(Customer, null=True, on_delete=models.SET_NULL)# on_delete=models.SET_NULL --> When an order is removed the order will remain in the database with a no value for the customer
    product = models.ForeignKey(Product, null=True, on_delete=models.SET_NULL)# on_delete=models.SET_NULL --> When an order is removed the order will remain in the database with a no value for the customer
    date_created = models.DateTimeField(auto_now_add=True, null=True)
